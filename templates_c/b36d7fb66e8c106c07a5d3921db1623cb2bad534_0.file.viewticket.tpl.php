<?php
/* Smarty version 3.1.48, created on 2025-06-01 13:34:33
  from '/home/zenexcloud/public_html/billing.zenexcloud.com/admin/templates/blend/viewticket.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_683c56e9856900_78635871',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b36d7fb66e8c106c07a5d3921db1623cb2bad534' => 
    array (
      0 => '/home/zenexcloud/public_html/billing.zenexcloud.com/admin/templates/blend/viewticket.tpl',
      1 => 1746641210,
      2 => 'file',
    ),
  ),
...
function content_683c56e9856900_78635871 (Smarty_Internal_Template $_smarty_tpl) {
...
<ul class="nav nav-tabs admin-tabs" role="tablist">
    ...
    <li>
        <a href="#tab7" role="tab" data-toggle="tab" onclick="loadTab(7, 'ticketactions', 0)"
            ><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['ticketactions'];?>
 <span class="label ticket-actions-count"><?php echo $_smarty_tpl->tpl_vars['numScheduledActions']->value;?>
</span></a>
    </li>
</ul>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="ticket-reply-submit-options clearfix">
            <div class="pull-left">
                ...
                <?php if (in_array('Create Scheduled Ticket Actions',$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
                <button type="button"
                        class="btn btn-default btns-padded btn-schedule-actions btn-scheduled-actions-manage">
                    <i class="fal fa-calendar" aria-hidden="true"></i><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['ticket']['action']['manageactions'];?>
...
' : this.value;" />
            ...
            <div id="ticketReplyScheduledActions" class="inner-container">
                <?php echo $_smarty_tpl->tpl_vars['scheduledActionsAndActionsPanel']->value;?>
...
">
            ...
            <tr>
                <td class="fieldlabel">
                    <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['preventClientClosure'];?>

                </td>
                <td class="fieldarea">
                    <label class="checkbox-inline">
                        <input type="checkbox" name="preventClientClosure"<?php if ($_smarty_tpl->tpl_vars['preventClientClosure']->value) {?> checked="checked"<?php }?>>
                        <?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['preventClientClosureDescription'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div id="relatedservicesexpand" class="ticket-action-buttons pull-right">
        <button id="btnRelatedServiceExpand" class="btn btn-default btn-xs<?php if (!(isset($_smarty_tpl->tpl_vars['relatedservicesexpand']->value)) || !$_smarty_tpl->tpl_vars['relatedservicesexpand']->value) {?> disabled" disabled="disabled<?php }?>">
            <span>
    ...
    <div id="selectRelatedService" class="ticket-action-buttons" style="margin-bottom:15px;">
        <button id="btnSelectRelatedService" type="button" class="btn btn-default btn-xs<?php if (!count($_smarty_tpl->tpl_vars['relatedservice']->value)) {?> disabled" disabled="disabled<?php }?>"<?php if ((isset($_smarty_tpl->tpl_vars['relatedservicesexpand']->value))) {?> data-expandable="<?php echo $_smarty_tpl->tpl_vars['relatedservicesexpand']->value;?>
"<?php }?>>
