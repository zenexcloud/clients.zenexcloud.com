<?php
/* Smarty version 3.1.48, created on 2025-06-01 11:57:22
  from 'mailMessage:message' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_683c4022ca8d71_48594874',
...
function content_683c4022ca8d71_48594874 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <img src="https://billing.zenexcloud.com/assets/img/logo.png" style="max-width:600px;padding:20px 20px 0 20px" id="headerImage" alt="Zenex Cloud" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                ...
                                                &nbsp;<a href="https://zenexcloud.com/">https://zenexcloud.com/</a>
                                                <span class="hide-mobile"> | </span>
                                                <a href="https://billing.zenexcloud.com/admin/">log in to the admin area</a>&nbsp;
                                            </td>
                                        </tr>
                                    </table>
                                </td>
