				...
				{foreach $client->payMethods->validateGateways() as $payMethod}
					<tr>
						...
						<td>
							...
							<a href="{routePath('account-paymentmethods-view', $payMethod->id)}" class="btn btn-sm btn-default{if $payMethod->getType() == 'RemoteBankAccount'} disabled{/if} btn-edit-cloudx" data-role="edit-payment-method">
