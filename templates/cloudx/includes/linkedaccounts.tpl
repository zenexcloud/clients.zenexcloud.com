...
{elseif $linkableProviders}
    ...
    {if $linkContext == 'registration'}
        <div class="sub-heading register-pg">
            <span>{lang key='or'} {lang key='remoteAuthn.titleSignUpVerb'}</span>
        </div>
    ...
    {elseif $linkContext == 'checkout-new'}
        ...
        <p class="small text-center text-muted checkout-new-pg-dsc">{lang key='remoteAuthn.saveTimeByLinking'}</p>
