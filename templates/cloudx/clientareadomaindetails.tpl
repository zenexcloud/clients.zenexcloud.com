        ...
        <div class="card">
            <div class="card-body">
                ...
                {if $addons.idprotection}
                    <div class="row mb-3 addon-cont-row">
                        <div class="col-2 col-md-1 text-center">
                            <i class="fas fa-shield-alt fa-3x"></i>
                        </div>
                        <div class="col-10 col-md-11">
                            <strong>{lang key='domainidprotection'}</strong>
                            <p class="a-desc">{lang key='domainaddonsidprotectioninfo'}</p>
                ...
                {if $addons.dnsmanagement}
                    <div class="row mb-3 addon-cont-row">
                        ...
                        <div class="col-10 col-md-11">
                            ...
                            <p class="a-desc">{lang key='domainaddonsdnsmanagementinfo'}</p>
                            <form action="clientarea.php?action=domainaddons" method="post">
                                <input type="hidden" name="id" value="{$domainid}"/>
                ...
                {if $addons.emailforwarding}
                    <div class="row mb-3 addon-cont-row">
                        ...
                        <div class="col-10 col-md-11">
                            ...
                            <p class="a-desc">{lang key='domainaddonsemailforwardinginfo'}</p>
                            <form action="clientarea.php?action=domainaddons" method="post">
                                <input type="hidden" name="id" value="{$domainid}"/>
