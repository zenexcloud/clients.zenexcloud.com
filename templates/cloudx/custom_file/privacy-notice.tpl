<section class="privacy-notice-cloudx">
    <div class="privacy-notice-banner-cloudx">
        <div class="container">
...
<section class="privacy-wrapper">
    <div class="container">
        <p>This is the Privacy Policy for ZenexCloud. It explains how we collect, use, and protect the information of our website visitors and customers. This policy is part of our Terms of Service and applies to all interactions with our website and services.</p>
        ...
        <div class="privacy-dt">            
            ...
            <p>We comply with applicable data privacy standards, including GDPR, ISO/IEC 27001 and and industry best practices.</p>
        </div>
        ...
        <div class="privacy-dt">            
            ...
            <p> To request any of the above, email us at privacy@zenexcloud.com. </p>
        </div>
