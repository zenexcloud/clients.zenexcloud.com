   ...
   <div class="container">
    {if $cloudx_product_data['status'] eq 'success'}
        {if $cloudx_product_data['result_count'] gt 0}
            <div class="titlebar">
                <h2>Efficient and Scalable cPanel Hosting Solutions</h2>
                <p class="mb-2"><b>Powerful, user-friendly hosting for individuals, startups, and growing businesses.</b></p>
                <p>ZenexCloud’s cPanel Hosting offers a simple, secure, and reliable way to manage your website, emails, domains, and more(all from one easy to use dashboard). Whether you're launching a personal blog or running a business website, cPanel makes hosting stress-free and efficient.</p>
            </div>
