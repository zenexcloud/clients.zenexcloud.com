                            ...
                            <div class="view-cart-items-header">
                                <div class="row">
                                    <div class="{if $showqtyoptions}col-sm-5{else}col-sm-7{/if} col-xs-7 col-7">
                                        <h6 class="view-page-tbl-head">{$LANG.orderForm.productOptions}</h6>
                                    </div>
                                    {if $showqtyoptions}
                                ...
                                <div role="tabpanel" class="tab-pane active promo" id="applyPromo">
                                    {if $promotioncode}
                                        ...
                                        <div class="text-center">
                                            <a href="{$WEB_ROOT}/cart.php?a=removepromo" class="btn btn-info btn-xs">
                                ...
                                <div role="tabpanel" class="tab-pane" id="calcTaxes">
                                    ...
                                    <form method="post" action="{$WEB_ROOT}/cart.php?a=setstateandcountry">
                                        <div class="form-group row">
                                            <label for="inputState" class="label-tax-state">{$LANG.orderForm.state}</label>
                                            <div class="col-sm-7">
                                                <input type="text" name="state" id="inputState" value="{$clientsdetails.state}" class="form-control"{if $loggedin} disabled="disabled"{/if} />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputCountry" class="label-tax-country">{$LANG.orderForm.country}</label>
                                            <div class="col-sm-7">
                                ...
                                <div class="recurring-totals clearfix">
                                    ...
                                    <span id="recurring" class="pull-right float-right recurring-charges">
                                        <span id="recurringMonthly" {if !$totalrecurringmonthly}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringmonthly}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermmonthly}</small>
                                        </span>
                                        <span id="recurringQuarterly" {if !$totalrecurringquarterly}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringquarterly}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermquarterly}</small>
                                        </span>
                                        <span id="recurringSemiAnnually" {if !$totalrecurringsemiannually}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringsemiannually}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermsemiannually}</small>
                                        </span>
                                        <span id="recurringAnnually" {if !$totalrecurringannually}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringannually}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermannually}</small>
                                        </span>
                                        <span id="recurringBiennially" {if !$totalrecurringbiennially}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringbiennially}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermbiennially}</small>
                                        </span>
                                        <span id="recurringTriennially" {if !$totalrecurringtriennially}style="display:none;"{/if}>
                                            <span class="cost">{$totalrecurringtriennially}</span> <small class="bill-cycle-summary">{$LANG.orderpaymenttermtriennially}</small>
                                        </span>
                                    </span>
                                </div>
