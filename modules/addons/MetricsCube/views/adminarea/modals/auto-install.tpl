...
<link href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap"
      rel="stylesheet">
<style>
    .lu-modal.lu-modal--auto-install {
    ...
    .lu-modal.lu-modal--auto-install.show {
        overflow: auto;
        opacity: 1;
        visibility: visible;
    }

    .lu-modal.lu-modal--auto-install.show .lu-modal__container {
        display: block;
        position: fixed;
        top: 0;
        right: 0;
    ...
    .lu-modal.lu-modal--auto-install.show .lu-modal__dialog {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__content {
        border-radius: 8px;
        box-shadow: 0px 16px 48px 6px #000 29;
        background: #fff;
        font-family: "Nunito", sans-serif;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__dialog {
        width: 720px;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__top {
        display: flex;
    ...
    @media (max-width: 767px) {
        .lu-modal.lu-modal--auto-install .lu-modal__top .lu-top__logo {
            max-width: 180px;
        }
    }

    .lu-modal.lu-modal--auto-install .lu-modal__top .lu-top__toolbar {
        position: absolute;
        right: 32px;
        margin: 0 !important;
        height: 20px;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__top .lu-top__toolbar .lu-close {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__top .lu-top__toolbar .lu-close svg path {
        transition: stroke 0.24s ease;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__top .lu-top__toolbar .lu-close:hover svg path {
        stroke: #5c4bd1;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__body {
        border: none;
        padding: 24px 32px 32px 32px !important;
        text-align: center;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__body .lu-modal__loader{
        background: #F1F4F8;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__heading {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__heading:has(.lu-modal__illustration) .lu-modal__title {
        margin-bottom: 32px !important;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__heading .lu-modal__title {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__heading .lu-modal__desc {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__heading .lu-modal__desc b {
        color: #29323a;
    }
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__heading .lu-modal__illustration {
        margin-bottom: 32px;
    }


    .lu-modal.lu-modal--auto-install .lu-modal__labels {
        margin-bottom: 32px;
    }
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__labels .lu-modal__labels-container span.label.label--primary {
        width: 100%;
        padding: 2px;
        font-size: 15px;
        line-height: 24px;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__labels .lu-modal__labels-container span.label.label--primary span.label-text {
        display: block;
        z-index: 1;
        background: linear-gradient(270deg, #EAE6FA 0%, #F4F3FD 100%);
        padding: 14px 16px;
        border-radius: 2px;
        width: 100%;
        white-space: normal
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__labels .lu-modal__labels-container span.label.label--primary .label--border-anim {
        filter: blur(10px);
        position: absolute;
        top: -30px;
        left: -30px;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__actions {
        display: flex;
        justify-content: center;
        flex-direction: column;
        align-items: center;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container {
        display: flex;
        justify-content: center;
        align-items: center;
        flex-wrap: wrap;
    ...
    @media (max-width: 513px) { 
        ...
        .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.lu-btn--lg {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.lu-btn--outline:hover {
        background: #F8FAFC !important;
        border: 1px solid #E1E5E8 !important;
    }
    
    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.btn-activate-addon svg {
    ...
    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.btn-activate-addon span.lu-btn__text {
        opacity: 1;
        visibility: visible;
        transition: all 0.24s ease;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.btn-activate-addon.btn-loading span.lu-btn__text {
        opacity: 0;
        visibility: hidden;
    }

    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.btn-activate-addon.btn-loading {
        background: #ffb34e !important;
    }
    
    .lu-modal.lu-modal--auto-install .lu-modal__actions .lu-modal__actions-btn-container button.lu-btn.btn-activate-addon.btn-loading svg {
        opacity: 1;
        visibility: visible
    }

    .lu-modal.lu-modal--auto-install .lu-modal__actions span.lu-modal__actions-info {
        font-size: 14px;
        line-height: 22px;
        font-weight: 400;
        color: #8A8F99;
    ...
    .lu-modal.lu-modal--auto-install .lu-modal [form-content], .lu-modal.lu-modal--auto-install .lu-modal [form-content-send] {
        transition: opacity 0.3s ease, visibility 0.3s ease;
        opacity: 1;
        visibility: visible;
    }

    .lu-modal.lu-modal--auto-install .lu-modal .fade-out {
        opacity: 0;
        visibility: hidden;
    }

    .lu-modal.lu-modal--auto-install .lu-modal .fade-in {
...
<div class="lu-modal lu-modal--auto-install" id="auto-install">
        ...
        <div class="lu-modal__dialog">
            <div class="lu-modal__content">
                ...
                <div class="lu-modal__heading">
                    <h2 class="lu-modal__title">Would you like to activate your FREE MetricsCube module?</h2>
                    <p class="lu-modal__desc">
                        The handy MetricsCube addon for WHMCS gives you a <b>free dashboard widget</b> revealing practical hints about your business performance and a smart customer overview that saves you time every day.
                    </p>
                </div>
                    ...
                    <div class="lu-modal__labels">
                        <div class="lu-modal__labels-container">
                            <span class="label label--primary">
                                ...
                                Instantly boost your WHMCS experience with real-time insights and smoother workflows!
                                </span>
                            <span class="label--border-anim"></span>
                            </span>
                        </div>
                    </div>
                    <div class="lu-modal__loader">
                        <img src="{$helper->img('auto-install-gif.gif')}" alt="">
                    </div>
                </div>
                <div class="lu-modal__actions">
                    <div class="lu-modal__actions-btn-container">
                        <button class="lu-btn lu-btn--primary lu-btn--lg btn-activate-addon" type="button">
                            <span class="lu-btn__text">Activate Now</span>
                            {literal}
                        ...
                        <button class="lu-btn lu-btn--default lu-btn--outline lu-btn--lg" type="button" data-dismiss="lu-modal"aria-label="Close">
                            <span class="lu-btn__text">Mabe Later</span>
                        </button>
                    </div>
                    <span class="lu-modal__actions-info">Get instant access with no signup or payment required.</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        if($('button.btn-activate-addon')) {
            $('button.btn-activate-addon').on('click', function (e) {
                $('button.btn-activate-addon').addClass('btn-loading');

                setTimeout(function() {
                    $('button.btn-activate-addon').removeClass('btn-loading');
                }, 1000);
            });
        }
    });
