        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="clientssummarybox">
                ...
                <ul>
                    ...
                    <li><a id="btnCloseClient" href="#" onClick="closeClient();return false" style="color:#000000;"><img src="images/icons/delete.png" border="0" align="absmiddle" /> {$_ADMINLANG.clientsummary.closeclient}</a></li>
